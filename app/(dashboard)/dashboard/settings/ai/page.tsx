...
export default async function AiSettingsPage() {
  ...
  return <>
    ...
    <div className="product-notice mt-5 px-4 py-3 text-sm font-medium">
      BYOK keys stay in this browser profile. When a key is active, Autobot prioritizes it for chat and browser-initiated inbox intelligence, and never saves it on the server.
    </div>
