...
export default async function UpgradePage() {
  ...
  return <><PageHeader label="Plans" title="More room for daily automation" description="Pro access is currently granted by an Autobot administrator." />
    ...
    <p className="mt-5 text-xs leading-5 text-muted">Plans change premium chat allowance. Inbox intelligence continues using Free or BYOK. After changing the Inbox model, <Link href="/dashboard/settings#ai-and-data" className="font-semibold text-forest underline underline-offset-2">reclassify recent email in Settings</Link>.</p>
  </>;
}
